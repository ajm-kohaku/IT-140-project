...
def main():
    ...
    while gamer.exit is False:
        ...
        gamer_input = gamer_input.lower().split()

        if gamer_input and gamer_input[0] == 'go' and len(gamer_input) == 2:
            move(gamer_input[1])
        elif gamer_input and gamer_input[0] == 'place' and len(gamer_input) == 2:
            place_token(gamer_input[1])
        elif gamer_input and gamer_input[0] == 'get' and len(gamer_input) == 2:
            get_item(gamer_input[1])
        elif gamer_input and gamer_input[0] == 'help':
            typewriter_output(instruction_text(), speed=0.01)
            time.sleep(1)
        elif gamer_input and gamer_input[0] == 'intro':
            typewriter_output(intro_text(),speed=0.01)
            time.sleep(1)
        elif gamer_input and gamer_input[0] == 'exit':
            exit_game()
        else:
            gamer.has_bad_input = True
